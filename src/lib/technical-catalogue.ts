...
export const TECHNICAL_CATALOGUE: TechCatalogueItem[] = [
  ...
  },
  {
    ...
    description: "Target for card/ACH processing and Financial Connections (replacing Plaid for new flows).",
  ...
  {
    name: "Plaid",
    category: "Banking & ACH (legacy)",
    description: "Optional legacy bank link; not used for KYC going forward — see Product roadmap.",
